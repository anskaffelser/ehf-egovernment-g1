...
// Folders
:rules-dir: /tmp/rules
:snippets-dir: ../../../../rules/get-evidence-1.0/snippets

//Internal

:link-codelist: link:/ehf-pre/g2/codelist/[Code list section]
:codelist-ICD: link:/ehf-pre/g2/codelist/ICD/[ICD Code list]
:eas: link:/ehf-pre/g2/codelist/EAS/[Electronic address Scheme]
